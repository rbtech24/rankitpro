  ...
  app.get("/api/integration/wordpress/download-plugin", isAuthenticated, isCompanyAdmin, async (req, res) => {
    ...
    try {
      ...
      const pluginCode = '<?php\\n' +
        ...
        '        ), $atts);\\n' +
        '        \\n' +
        '        return "<div class=\\"rankitpro-container\\" data-company=\\"" . esc_attr($atts["company"]) . "\\" data-limit=\\"" . esc_attr($atts["limit"]) . "\\">Loading check-ins...</div>";\\n' +
        '    }\\n' +
        '    \\n' +
        ...
        '        echo "<h3>Usage</h3>";\\n' +
        '        echo "<p>Use the shortcode [rankitpro_checkins] to display check-ins on your pages.</p>";\\n' +
        '        echo "</div>";\\n' +
        '    }\\n' +
        '}\\n\\n' +
        'new RankItProPlugin();\\n' +
