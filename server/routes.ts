      ...
      if (format === 'html') {
        ...
        if (type === 'checkins' || type === 'all') {
          if (content.checkins && content.checkins.length > 0) {
            ...
            html += '<div style="display: grid !important; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)) !important; gap: 20px !important; margin: 20px 0 !important; width: 100% !important; box-sizing: border-box !important;">';
        ...
        if (type === 'testimonials' || type === 'all') {
          try {
            ...
            if (testimonials && testimonials.length > 0) {
              ...
              html += '<div style="display: grid !important; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)) !important; gap: 20px !important; margin: 20px 0 !important; width: 100% !important; box-sizing: border-box !important;">';
