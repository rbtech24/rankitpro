    ...
    <aside className={cn("bg-white border-r border-gray-200 w-64 flex flex-col", className)}>
          ...
          <>
            <div className="mb-4">
              ...
              <Link 
                ...
                className={cn(
                  "flex items-center px-3 py-2 text-sm font-medium rounded-md hover:bg-gray-100 mb-1 text-gray-700 no-underline",
                  isActive("/api-testing") && "bg-blue-50 border-l-4 border-blue-600 text-blue-700"
                )}
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500 mr-3">
                  <path d="M12 20h9"/>
          ...
          <>
            ...
            <div className="mb-4">
              ...
              <Link 
                ...
                className={cn(
                  "flex items-center px-3 py-2 text-sm font-medium rounded-md hover:bg-gray-100 mb-1 text-gray-700 no-underline",
                  isActive("/integrations") && "bg-blue-50 border-l-4 border-blue-600 text-blue-700"
                )}
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500 mr-3">
                  <circle cx="12" cy="12" r="10"/>
            ...
            <div className="mb-4">
              ...
              <Link 
                ...
                className={cn(
                  "flex items-center px-3 py-2 text-sm font-medium rounded-md hover:bg-gray-100 mb-1 text-gray-700 no-underline",
                  isActive("/billing") && "bg-blue-50 border-l-4 border-blue-600 text-blue-700"
                )}
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500 mr-3">
                  <rect width="20" height="14" x="2" y="5" rx="2"/>
      ...
      <div className="border-t border-gray-200 p-4">
        <button
          ...
          className="flex items-center px-3 py-2 text-sm font-medium rounded-md hover:bg-red-50 hover:text-red-700 text-gray-700 w-full transition-colors"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500 mr-3">
            <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/>
            <polyline points="16,17 21,12 16,7"/>
