...
export default function TechnicianSidebar({ className, activeSection, onSectionChange }: TechnicianSidebarProps) {
      ...
      <nav className="px-2 pt-2 flex-1 overflow-y-auto">
        <div className="mb-4">
          ...
          <button 
            ...
            className={cn(
              "flex items-center px-3 py-2 text-sm font-medium rounded-md hover:bg-gray-100 mb-1 w-full text-left",
          ...
          <button 
            ...
            className={cn(
              "flex items-center px-3 py-2 text-sm font-medium rounded-md hover:bg-gray-100 mb-1 w-full text-left",
              isActive("mobile") && "bg-blue-50 border-l-3 border-blue-600"
            )}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500 mr-3">
          ...
          <button 
            ...
            className={cn(
              "flex items-center px-3 py-2 text-sm font-medium rounded-md hover:bg-gray-100 mb-1 w-full text-left",
              isActive("blog") && "bg-blue-50 border-l-3 border-blue-600"
            )}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500 mr-3">
