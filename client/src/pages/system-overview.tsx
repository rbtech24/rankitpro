              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <div className="h-4 w-4 rounded-full bg-purple-100 flex items-center justify-center">
                    <div className="text-purple-600 text-xs font-bold">$</div>
                  </div>
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">${((stats as any)?.monthlyRevenue || 0).toLocaleString()}</div>
                  <p className="text-xs text-muted-foreground">
                    ${((stats as any)?.totalRevenue || 0).toLocaleString()} total revenue
                  </p>
                </CardContent>
              </Card>
